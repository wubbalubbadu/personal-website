...
export const timelineEvents: TimelineEvent[] = [
  {
    ...
    detail: "Also B.M. Flute Performance. GPA 3.98.",
    start: 2021,
    end: 2025,
    kind: "education",
  },
...

  {
    ...
    detail: "Early 2024: chose intensive conservatory-track training and competitions to find my ceiling as a player.",
    start: 2024,
    kind: "milestone",
  },
  {
