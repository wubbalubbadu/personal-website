...
import PracticeDataSummary from "./PracticeDataSummary";
...
export default function FluteStudioLayout({children}:{children:React.ReactNode}){return <>{children}<PracticeSessionTimer/><PracticeDataSummary/><SavedMusicHome/><FloatingPracticeTools/></>}
