...
export default function FluteStudioLayout({children}:{children:React.ReactNode}){return <LanguageProvider><PracticeAudioProvider><StudioNavigation/><div className="studio-route">{children}</div><PracticeSessionTimer/><PracticeToolDock/><CookiePet/></PracticeAudioProvider></LanguageProvider>}
