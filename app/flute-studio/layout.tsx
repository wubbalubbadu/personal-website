...
export default function FluteStudioLayout({children}:{children:React.ReactNode}){return <LanguageProvider><StudioNavigation/><div className="studio-route">{children}</div><PracticeToolDock/><CookiePet/></LanguageProvider>}
