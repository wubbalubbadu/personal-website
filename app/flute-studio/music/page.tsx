...
export default function MusicLibrary(){
  const {t}=useLanguage();
  const labels:Record<string,string>={all:t.library.all,exercise:t.library.exercise,repertoire:t.library.repertoire,etude:t.library.etude,pop:t.library.pop,beginner:t.library.beginner,"early-intermediate":t.library.earlyIntermediate,intermediate:t.library.intermediate,advanced:t.library.advanced};
      ...
      <div className="library-content">
        ...
        <div className="search-filter">
          ...
          <div className="filter-menu">
            <button className={filterOpen||difficulty!=="all"?"filter-trigger active has-tip":"filter-trigger has-tip"} data-tip={t.library.filterAria} onClick={()=>setFilterOpen(open=>!open)} aria-label={t.library.filterAria} aria-expanded={filterOpen}>
            ...
            {filterOpen&&<>
              ...
              <section className="filter-menu-pop" role="dialog" aria-label={t.library.filtersAria}>
                ...
                {difficulty!=="all"&&<button type="button" className="filter-menu-reset" onClick={()=>setDifficulty("all")}>{t.library.filterReset}</button>}
              </section>
            </>}
          </div>
        </div>
        ...
        {difficulty!=="all"&&<p className="active-difficulty">{labels[difficulty]}</p>}
