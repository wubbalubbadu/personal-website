...
const scaleConfig:ScoreViewerConfig={title:"Major Scales",subtitle:"C major and G major · Two octaves",asset:"/scales-flute.mxl",id:"major-scales",backHref:"/flute-studio/exercises",pitches,measureStarts,events:pitches.map((p,index)=>({p,d:measureStarts.includes(index+1)||index===0||index===29?4:2}))};
