...
const scaleConfig:ScoreViewerConfig={title:"Major Scales",composer:"Cookie Flute Studio",asset:"/scales-flute.mxl",id:"scale-studio",backHref:"/flute-studio/exercises",pitches,measureStarts,events:pitches.map((p,index)=>({p,d:measureStarts.includes(index+1)||index===0||index===29?4:2}))};
