...
export default function StudioHome(){
  ...
  useEffect(()=>{const saved=localStorage.getItem("cookie:practice-plan");if(saved)setDone(JSON.parse(saved))},[]);
  ...
  return <main className="studio-shell"><aside className="studio-nav"><a href="/" className="studio-logo"><span>◒</span><b>Cookie</b><small>FLUTE STUDIO</small></a><nav><a className="active" href="/flute-studio"><i>⌂</i>Home</a><a href="/flute-studio/music"><i>♫</i>Music</a><a href="/flute-studio/exercises/scales"><i>◎</i>Exercises</a><a href="#practice"><i>✓</i>Practice</a></nav><div className="studio-profile"><span>HW</span><p><b>Haylie&apos;s studio</b><small>Flute · Teacher</small></p></div></aside>
    <section className="studio-main" onScroll={event=>setCompact(event.currentTarget.scrollTop>42)}>
      <header className={compact?"home-header compact":"home-header"}><div className="home-compact-nav"><span className="home-mark">◒</span><strong>Home</strong><a href="/flute-studio/music" aria-label="Search library">⌕</a></div><div className="home-large-title"><div><p>{today.toLocaleDateString(undefined,{weekday:"long",month:"long",day:"numeric"})}</p><h1>Good {today.getHours()<12?"morning":today.getHours()<18?"afternoon":"evening"}, Haylie.</h1></div><a className="header-library-link" href="/flute-studio/music">Browse library</a></div></header>
