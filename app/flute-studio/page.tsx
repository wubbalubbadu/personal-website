    ...
    <section className="studio-main" onScroll={event=>setCompact(event.currentTarget.scrollTop>42)}>
      ...
      <div className="home-content">
        ...
        <div className="home-layout"><div className="studio-left">
          <section className="home-section recent-section"><header><h2><a href="/flute-studio/music">Continue practicing <span aria-hidden="true">›</span></a></h2></header><div className="continue-row"><a className="continue-main" href="/flute-studio/music/mystery-of-love"><span className="continue-icon">♫</span><div><h3>Mystery of Love</h3><p>Sufjan Stevens · Repertoire · E minor</p></div></a><button className={favorites.includes("mystery-of-love")?"continue-star saved":"continue-star"} onClick={toggleMysteryFavorite} aria-label={favorites.includes("mystery-of-love")?"Remove Mystery of Love from saved music":"Save Mystery of Love"} title={favorites.includes("mystery-of-love")?"Remove from saved music":"Save music"}>{favorites.includes("mystery-of-love")?"★":"☆"}</button></div></section>
          <SavedMusicHome/>
