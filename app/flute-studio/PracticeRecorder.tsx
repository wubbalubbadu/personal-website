...
export default function PracticeRecorder(){
  const {t}=useLanguage();
  const [recording,setRecording]=useState(false),[elapsed,setElapsed]=useState(0),[levels,setLevels]=useState<number[]>(Array(18).fill(5)),[audioUrl,setAudioUrl]=useState<string|null>(null),[error,setError]=useState("");
