...
export const exerciseCatalog:readonly ExerciseEntry[]=[
  ...
  },
  {
    ...
    zhTitle:"每日练习 第一首",
    detail:"Taffanel & Gaubert — the classic finger warm-up",
    zhDetail:"塔法内尔与戈贝尔——经典手指热身",
    href:null,
    minutes:12,
  ...
  },
  {
    ...
    zhTitle:"长音阶梯",
    detail:"A guided sequence for a centered sound and steady air",
    zhDetail:"引导式长音练习，训练集中的音色与稳定的气息",
    href:null,
    minutes:8,
    difficulty:"beginner",
    key:"C major",
